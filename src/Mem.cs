...
/// <summary>Respects the std::mem in Rust</summary>
public static class Mem
{
    /// <summary>Swaps two value mem</summary>
    public static void Swap<T>(ref T a, ref T b)
    {
        (a, b) = (b, a);
    }

    /// <summary>Take value and replace to null</summary>
    ...
    /// <summary>Replace value and take previous value</summary>
    ...
    /// <summary>Replace value if previous is expected</summary>
